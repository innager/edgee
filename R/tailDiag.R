...
#'
#'Evaluate tail behavior and usability for 2nd - 5th order (terms 1-4) Edgeworth
#'expansions for a t-statistic.
#'
...
#'  a two-sample test.
#'@param type which Edgeworth expansions are to be evaluated: \code{"short"} for
...
#'@param moder \code{logical} value for calculating augmented degrees of freedom
